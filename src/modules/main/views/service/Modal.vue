...
<script>
// https://euvl.github.io/vue-js-modal => existing document about this...
// https://vuetifyjs.com/en/getting-started/installation => existing document about vuetifyjs cf. v-dialog
